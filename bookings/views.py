...
def send_email(request):
    if request.user.is_authenticated:
        return requests.post(
            ...
            data={"from": "Msafiri Express <postmaster@sandbox5e710d75bee5465eb57b7ed5e34dd1c3.mailgun.org>",
...
def search(request):
    queryset_list = TravelRoute.objects.order_by('-date_of_travel').filter(is_published=True)
